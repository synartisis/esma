...
/** @typedef {import('esma').ErrorHandler} ErrorHandler */
/** @typedef {import('esma').Router} Router */
/** @typedef {import('esma/private').RouterObject} RouterObject */
/** @typedef {import('esma/private').MiddlewareEntry} MiddlewareEntry */
...
/** @type {(path: string, handlers: Array<Middleware | RouterObject>, options: any) => MiddlewareEntry} */
      ...
      for await (const handler of this.handlers) {
        ...
        if (typeof handler === 'function') {
          ...
          try {
            ...
            if (error instanceof Error) throw new HttpError(500, error.stack ?? error.message)
...
/** @type {(req: Request, method: string) => boolean} */
...
/** @type {(req: Request, reqData: { params: Record<string, string>, query: Record<string, string> }) => void} */
