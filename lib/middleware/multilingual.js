/** @type {(languages: string[]) => esma.Handler} */
export function multilingual(languages) {
  if (!Array.isArray(languages) || languages.length === 0 || languages.some(lang => typeof lang !== 'string' || lang === '')) {
    throw new Error(`esma.multilingual: languages not defined`)
  }
