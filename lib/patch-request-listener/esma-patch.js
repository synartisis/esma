...
import { attachSession } from '../server/session.js'
...
/** @type {(resExpress: http.ServerResponse & ExpressResponsePatch, esmaReq: esma.Request, ctx: esma.Context) => esma.Response} */
