...
/** @type {(httpRequest: http.IncomingMessage, httpResponse: http.ServerResponse, ctx: types.Context) => { reqEsma: esma.Request, resEsma: esma.Response }} */
...
/** @type {(httpResponse: http.ServerResponse, reqEsma: esma.Request, ctx: types.Context) => esma.Response} */
